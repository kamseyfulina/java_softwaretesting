  ...
  public void ensurePreconditions() {
    ...
    if (app.db().contacts().size() == 0) {
      ...
      app.contact().create(new ContactData().withFirstname("Петр").withMiddlename("Иванович").withLastname("Иванов")
              .withHome("88435235412").withMobile("89503336699").withWork("222222225566").withEmail("ivanov@testmail.ru").withGroup(defaultNameGroup).withAddress("ул. Главная"));
    }
  }
